...
public enum Level { None = -1, Menu = 0, Forest1 = 1, NoGame1 = 2, SandIce1 = 3, Forest5 = 4, Snow4 = 5, MixAll1 = 6, Sand1 = 7 };
...
public class GameManager : MonoBehaviour {
    ...
    Dictionary<Level, string> _levelWords = new Dictionary<Level, string>() { { Level.Forest1, "L1" }, { Level.NoGame1, "L2" }, { Level.SandIce1, "L3" }, { Level.Forest5, "L4" }, { Level.Snow4, "L5" }, { Level.MixAll1, "L6" }, { Level.Sand1, "L7" } };
