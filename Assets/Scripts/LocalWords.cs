...
public class LocalWords : MonoBehaviour {
    ...
    public static Dictionary<Level, List<string>> levelWords = new Dictionary<Level, List<string>>() {
        { Level.Forest1 , new List<string>() {"it", "bye_bye", "cool", "eat1", "school", "home", "friend", "boy", "girl", "speak", "play", "book", "say", "come_on", "sorry", "read", "write", "learn", "come" } },
        ...
        { Level.SandIce1 , new List<string>() { "pet", "bet", "neighbour", "classmate", "sister", "teacher", "child", "children", "family", "man", "parents", "love", "baby", "young", "old" } },
        { Level.NoBoard2 , new List<string>() { "dessert", "fork", "leak", "glass", "knife", "lick", "make", "more", "plate", "spoon", "sweet", "pepper", "pear", "meat", "cup", "water", "milk" } },
        ...
        { Level.NoBoard3 , new List<string>() { "leave", "english", "live", "finnish", "swedish", "finland", "finn", "village", "europe", "city", "town", "language" } },
